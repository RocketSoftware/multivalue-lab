...
<Assembly: EdmSchemaAttribute("35237518-1ef0-46d8-8ae2-5262ca21162b")>
...
Public Partial Class CustomerContainer
    ...
    ''' No Metadata Documentation available.
    ''' </summary>
    Public Function GetCustomer() As ObjectResult(Of CUSTOMER)
        Return MyBase.ExecuteFunction(Of CUSTOMER)("GetCustomer")
    ...
    Public Function GetCustomer(mergeOption As MergeOption) As ObjectResult(Of CUSTOMER)
        Return MyBase.ExecuteFunction(Of CUSTOMER)("GetCustomer", mergeOption)
